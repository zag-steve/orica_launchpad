...
(function(root, factory) {
  ...
  PleaseWait = (function() {
    PleaseWait._defaultOptions = {
      ...
      logo: null,
      loadingHtml: null,
      template: "<div class='pg-loading-inner'><div class='pg-loading-center-outer'><div class='pg-loading-center-middle'><h1 class='pg-loading-logo-header'>"+
	  "<img class='pg-loading-logo'></img></h1><div class='pg-loading-html'></div></div></div></div>",
